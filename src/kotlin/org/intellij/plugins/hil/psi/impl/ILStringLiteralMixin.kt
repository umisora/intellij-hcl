...
open class ILStringLiteralMixin(node: ASTNode) : ILLiteralExpressionImpl(node), PsiLanguageInjectionHost {
  companion object {
    val LOG = Logger.getInstance(ILStringLiteralMixin::class.java)
  }

  override fun isValidHost() = true

  override fun updateText(s: String): ILStringLiteralMixin {
  ...
  override fun createLiteralTextEscaper(): LiteralTextEscaper<out PsiLanguageInjectionHost> {
    return object : LiteralTextEscaper<ILStringLiteralMixin>(this) {
